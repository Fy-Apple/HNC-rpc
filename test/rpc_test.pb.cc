...
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_rpc_5ftest_2eproto = nullptr;
static const ::_pb::ServiceDescriptor*
    file_level_service_descriptors_rpc_5ftest_2eproto[1];
const ::uint32_t
    TableStruct_rpc_5ftest_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::rpc_test::ResultCode, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ...
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::rpc_test::ResultCode, _impl_.errcode_),
        PROTOBUF_FIELD_OFFSET(::rpc_test::ResultCode, _impl_.errmsg_),
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::rpc_test::LoginRequest, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::rpc_test::LoginRequest, _impl_.name_),
        PROTOBUF_FIELD_OFFSET(::rpc_test::LoginRequest, _impl_.pwd_),
        PROTOBUF_FIELD_OFFSET(::rpc_test::LoginResponse, _impl_._has_bits_),
        PROTOBUF_FIELD_OFFSET(::rpc_test::LoginResponse, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
        ~0u,  // no _split_
        ~0u,  // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::rpc_test::LoginResponse, _impl_.result_),
        PROTOBUF_FIELD_OFFSET(::rpc_test::LoginResponse, _impl_.success_),
        0,
        ~0u,
};
...
static const ::_pbi::MigrationSchema
    schemas[] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::rpc_test::ResultCode)},
        {10, -1, -1, sizeof(::rpc_test::LoginRequest)},
        {20, 30, -1, sizeof(::rpc_test::LoginResponse)},
};
static const ::_pb::Message* const file_default_instances[] = {
    &::rpc_test::_ResultCode_default_instance_._instance,
    &::rpc_test::_LoginRequest_default_instance_._instance,
    &::rpc_test::_LoginResponse_default_instance_._instance,
};
const char descriptor_table_protodef_rpc_5ftest_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
    "\n\016rpc_test.proto\022\010rpc_test\"-\n\nResultCode"
    "\022\017\n\007errcode\030\001 \001(\005\022\016\n\006errmsg\030\002 \001(\014\")\n\014Log"
    "inRequest\022\014\n\004name\030\001 \001(\014\022\013\n\003pwd\030\002 \001(\014\"F\n\r"
    "LoginResponse\022$\n\006result\030\001 \001(\0132\024.rpc_test"
    ".ResultCode\022\017\n\007success\030\002 \001(\0102J\n\016UserServ"
    "iceRpc\0228\n\005Login\022\026.rpc_test.LoginRequest\032"
    "\027.rpc_test.LoginResponseB\003\200\001\001b\006proto3"
};
static ::absl::once_flag descriptor_table_rpc_5ftest_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_rpc_5ftest_2eproto = {
    false,
    false,
    277,
    descriptor_table_protodef_rpc_5ftest_2eproto,
    "rpc_test.proto",
    &descriptor_table_rpc_5ftest_2eproto_once,
    nullptr,
    0,
    3,
    schemas,
    file_default_instances,
    TableStruct_rpc_5ftest_2eproto::offsets,
    file_level_enum_descriptors_rpc_5ftest_2eproto,
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:rpc_test.ResultCode)
}
inline PROTOBUF_NDEBUG_INLINE ResultCode::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::rpc_test::ResultCode& from_msg)
...
ResultCode::ResultCode(
  ...
  // @@protoc_insertion_point(copy_constructor:rpc_test.ResultCode)
}
inline PROTOBUF_NDEBUG_INLINE ResultCode::Impl_::Impl_(
...
ResultCode::~ResultCode() {
  // @@protoc_insertion_point(destructor:rpc_test.ResultCode)
  SharedDtor(*this);
}
...
inline void* ResultCode::PlacementNew_(const void*, void* mem,
                                        ::google::protobuf::Arena* arena) {
...
const ::google::protobuf::internal::ClassDataFull ResultCode::_class_data_ = {
    ...
    &descriptor_table_rpc_5ftest_2eproto,
    nullptr,  // tracker
};
const ::google::protobuf::internal::ClassData* ResultCode::GetClassData() const {
...
const ::_pbi::TcParseTable<1, 2, 0, 0, 2> ResultCode::_table_ = {
  {
    ...
    ::_pbi::TcParser::GetTable<::rpc_test::ResultCode>(),  // to_prefetch
...
// @@protoc_insertion_point(message_clear_start:rpc_test.ResultCode)
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* ResultCode::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:rpc_test.ResultCode)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          // @@protoc_insertion_point(serialize_to_array_end:rpc_test.ResultCode)
          return target;
        }
        ...
        ::size_t ResultCode::ByteSizeLong() const {
          const ResultCode& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:rpc_test.ResultCode)
          ::size_t total_size = 0;
...
void ResultCode::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:rpc_test.ResultCode)
...
// @@protoc_insertion_point(class_specific_copy_from_start:rpc_test.ResultCode)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:rpc_test.LoginRequest)
}
inline PROTOBUF_NDEBUG_INLINE LoginRequest::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::rpc_test::LoginRequest& from_msg)
...
LoginRequest::LoginRequest(
  ...
  // @@protoc_insertion_point(copy_constructor:rpc_test.LoginRequest)
}
inline PROTOBUF_NDEBUG_INLINE LoginRequest::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
LoginRequest::~LoginRequest() {
  // @@protoc_insertion_point(destructor:rpc_test.LoginRequest)
  SharedDtor(*this);
}
...
const ::_pbi::TcParseTable<1, 2, 0, 0, 2> LoginRequest::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::rpc_test::LoginRequest>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // bytes pwd = 2;
    {::_pbi::TcParser::FastBS1,
...
// @@protoc_insertion_point(message_clear_start:rpc_test.LoginRequest)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* LoginRequest::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:rpc_test.LoginRequest)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          // @@protoc_insertion_point(serialize_to_array_end:rpc_test.LoginRequest)
          return target;
        }
        ...
        ::size_t LoginRequest::ByteSizeLong() const {
          const LoginRequest& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:rpc_test.LoginRequest)
          ::size_t total_size = 0;
...
void LoginRequest::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:rpc_test.LoginRequest)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:rpc_test.LoginRequest)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:rpc_test.LoginResponse)
}
inline PROTOBUF_NDEBUG_INLINE LoginResponse::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::rpc_test::LoginResponse& from_msg)
...
LoginResponse::LoginResponse(
  ...
  _impl_.result_ = (cached_has_bits & 0x00000001u) ? ::google::protobuf::Message::CopyConstruct<::rpc_test::ResultCode>(
                              arena, *from._impl_.result_)
                        : nullptr;
  _impl_.success_ = from._impl_.success_;

  // @@protoc_insertion_point(copy_constructor:rpc_test.LoginResponse)
}
inline PROTOBUF_NDEBUG_INLINE LoginResponse::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
LoginResponse::~LoginResponse() {
  // @@protoc_insertion_point(destructor:rpc_test.LoginResponse)
  SharedDtor(*this);
}
...
const ::_pbi::TcParseTable<1, 2, 1, 0, 2> LoginResponse::_table_ = {
  {
    ...
    ::_pbi::TcParser::GenericFallback,  // fallback
    #ifdef PROTOBUF_PREFETCH_PARSE_TABLE
    ::_pbi::TcParser::GetTable<::rpc_test::LoginResponse>(),  // to_prefetch
    #endif  // PROTOBUF_PREFETCH_PARSE_TABLE
  }, {{
    // bool success = 2;
    ...
    {::_pbi::TcParser::GetTable<::rpc_test::ResultCode>()},
  }}, {{
  }},
};

PROTOBUF_NOINLINE void LoginResponse::Clear() {
// @@protoc_insertion_point(message_clear_start:rpc_test.LoginResponse)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
  ...
  _internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
        ...
        ::uint8_t* LoginResponse::_InternalSerialize(
...
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:rpc_test.LoginResponse)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          // @@protoc_insertion_point(serialize_to_array_end:rpc_test.LoginResponse)
          return target;
        }
        ...
        ::size_t LoginResponse::ByteSizeLong() const {
          const LoginResponse& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:rpc_test.LoginResponse)
          ::size_t total_size = 0;
...
void LoginResponse::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:rpc_test.LoginResponse)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    if (_this->_impl_.result_ == nullptr) {
      _this->_impl_.result_ =
          ::google::protobuf::Message::CopyConstruct<::rpc_test::ResultCode>(arena, *from._impl_.result_);
    } else {
...
// @@protoc_insertion_point(class_specific_copy_from_start:rpc_test.LoginResponse)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
const ::google::protobuf::ServiceDescriptor* UserServiceRpc::descriptor() {
  ::google::protobuf::internal::AssignDescriptors(&descriptor_table_rpc_5ftest_2eproto);
  return file_level_service_descriptors_rpc_5ftest_2eproto[0];
}
...
void UserServiceRpc::Login(::google::protobuf::RpcController* controller,
                         const ::rpc_test::LoginRequest*, ::rpc_test::LoginResponse*, ::google::protobuf::Closure* done) {
...
void UserServiceRpc::CallMethod(
  ...
  ABSL_DCHECK_EQ(method->service(), file_level_service_descriptors_rpc_5ftest_2eproto[0]);
  switch (method->index()) {
    case 0:
      this->Login(controller,
                   ::google::protobuf::DownCastMessage<::rpc_test::LoginRequest>(request),
                   ::google::protobuf::DownCastMessage<::rpc_test::LoginResponse>(response),
                   done);
      break;
...
const ::google::protobuf::Message& UserServiceRpc::GetRequestPrototype(
  ...
  switch (method->index()) {
    case 0:
      return ::rpc_test::LoginRequest::default_instance();
...
const ::google::protobuf::Message& UserServiceRpc::GetResponsePrototype(
  ...
  switch (method->index()) {
    case 0:
      return ::rpc_test::LoginResponse::default_instance();
...
void UserServiceRpc_Stub::Login(::google::protobuf::RpcController* controller,
                              ...
                              ::rpc_test::LoginResponse* response, ::google::protobuf::Closure* done) {
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ PROTOBUF_UNUSED =
        (::_pbi::AddDescriptors(&descriptor_table_rpc_5ftest_2eproto),
         ::std::false_type{});
